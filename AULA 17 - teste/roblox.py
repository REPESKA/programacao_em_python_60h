...
trex1 =  pygame.image.load('assets/MOV1.png')
trex2 =  pygame.image.load('assets/MOV2.png')
trex3 =  pygame.image.load('assets/MOV3.png')
...
while True:
    ...
    if not game_over:
        ...
        if cacto_x < -50:
            ...
            cacto_img1 = random.choice([cacto_img1, cacto_img2])
            score += 2
