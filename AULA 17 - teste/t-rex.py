...
cacto = pygame.image.load('assets/cacto.png')
cacto2 = pygame.image.load('assets/cacto2.png') 

chao =  pygame.image.load('assets/cenario.png')
...
while True:
    ...
    if not game_over:
        ...
        if cacto_x < -50:
            ...
            cacto = random.choice([cacto, cacto2])
            score += 1
        ...
        cacto_rect =  cacto.get_rect(topleft = (cacto_x, cacto_y))
        cacto2_rect =  cacto2.get_rect(topleft = (cacto_x, cacto_y))
    ...
    tela.blit(cacto2, (cacto_x, cacto_y))
